...
2. When an issue is created, a [template](https://github.com/facelessuser/ExportHtml/blob/master/.github/ISSUE_TEMPLATE.md) will be shown, please fill out the appropriate sections. If the template is not followed, the issue will be marked `Invalid` and closed.
